...
<head>
	...
	<script type="text/javascript">
		   		...
		   		$("span[name='registrar_pedido']").click(function(){
		   			...
		   			var cant=$(this).parent().find("input[name='cantidad']").val();
				   		...
				   		$.ajax({
				   			...
				   			type: 'post',
				   			dataType: 'json',
				   			data: {'username': $.cookie("username"),"prenda":prenda,"talla":talla,"cantidad":cant,"coleccion":"casual"},
		  ...
		  $(document).ready(function(){
		  	...
		  	$("#jeans>div>div>img").click(function(){
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div id="coleccion-tabs">
						<ul>
							<li><a href="#jeans"><span>Jeans</span></a></li>
							<li><a href="#abrigos"><span>Abrigos</span></a></li>
							<li><a href="#blusas"><span>Blusas</span></a></li>
							<li><a href="#short"><span>Short</span></a></li>
						</ul>

						<div id="jeans" class="" style="">
							<div class="row justify-content-sm-around">
								<?php 
									include("conexion.php");

									 $sql= "SELECT * FROM m_casual WHERE tipo='jeans'";
									...
									echo "<div class='col-sm-3 card-col-deportiva text-center' style='' name='deportiva'>";
										echo "<span name='registrar_pedido' class='add-car'><img src='img/add_cart.svg' style='width:55%;' alt=''></span>";
									 	echo "<img style='margin-bottom:3%;width: 70%;' src='$row[extension_img]' alt='' onclick=''>";
										...
										echo			"<li><img src='img/jeans/jeans_1.jpg' alt=''></li>";
										echo			"<li><img src='img/jeans/jeans_2.jpg' alt=''></li>";
										echo			"<li><img src='img/jeans/jeans_3.jpg' alt=''></li>";
										echo		"</ul>";
										echo 	"</div>";
										echo "</div>";
									echo "</div>";
							...
							<div class="row justify-content-sm-around">
								<?php 
									include("conexion.php");
									 ...
									 $sql= "SELECT * FROM m_casual WHERE tipo='abrigos'";
							...
							<div class="row justify-content-sm-around">
								<?php 
									include("conexion.php");
									 ...
									 $sql= "SELECT * FROM m_casual WHERE tipo='blusa'";
							...
							<div class="row justify-content-sm-around">
								<?php 
									include("conexion.php");
									 ...
									 $sql= "SELECT * FROM m_casual WHERE tipo='short'";
